...
public class EmbeddingServiceImpl implements EmbeddingService {
    ...
    public List<RecommendHerbsDTO> similaritySearch(String question) {
        ...
        String template = """
                ...
                컨텍스트에 나와 있는 약초 중에서 사용자의 질문에 등장하는 의미있는 증상에 관한 문장이 존재하는 약초를 5개 내로 선택하여 포맷형태의 배열로 응답해야 합니다.
                answer 에는 왜 해당 약초를 추천하는지 그 외 도움이 되는 내용을 포함해서 친절하게 답변해야 합니다.
                증상과 크게 연관은 없더라도 증상과 관련해서 추가로 알아두면 좋은 약초가 있으면 포함시킵니다. 이 때 왜 추천하는지 이유도 answer에 명시해야 합니다.
                ...
                priority 에는 우선순위로 현재 사용자에게 꼭 필요한 약초부터 1 ~ 5 순서로 순위를 매겨주세요.
